...
std::any EvalVisitor::visitAssign(LabeledExprParser::AssignContext *ctx) {
    ...
    int value = std::any_cast<int>(visit(ctx->expr()));			// compute value of expression
...
std::any EvalVisitor::visitMulDiv(LabeledExprParser::MulDivContext *ctx) {
    int left = std::any_cast<int>(visit(ctx->expr(0)));         // value of left expression
    int right = std::any_cast<int>(visit(ctx->expr(1)));        // value of right expression
...
std::any EvalVisitor::visitParens(LabeledExprParser::ParensContext *ctx) {
    return std::any_cast<int>(visit(ctx->expr()));              // return child expr's value
}
