...
A translation of the symbol table for classes from T4-Symbols.pptx to C++ and ANTLR4, in the assignment format.
...
Examples:
```
bin/classsym t3.cymbol
bin/classsym AB.cymbol
